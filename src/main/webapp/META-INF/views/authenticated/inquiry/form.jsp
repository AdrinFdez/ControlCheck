...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.inquiry.form.label.moneymin" path="moneyMin"/>
	<acme:form-textbox code="authenticated.inquiry.form.label.moneymax" path="moneyMax"/>
	<acme:form-textbox code="authenticated.inquiry.form.label.mail" path="mail"/>
