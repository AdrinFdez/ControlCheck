...
@Service
public class EntrepreneurInvestmentRoundApplicationListByCreationService implements AbstractListService<Entrepreneur, InvestmentRoundApplication> {
	...
	public Collection<InvestmentRoundApplication> findMany(final Request<InvestmentRoundApplication> request) {
		...
		result = this.repository.findAllByCreation(idEntrepreneur);
