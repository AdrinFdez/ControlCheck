...
@Service
public class AuthenticatedTechnologyRecordListByRatingService implements AbstractListService<Authenticated, TechnologyRecord> {
	...
	public Collection<TechnologyRecord> findMany(final Request<TechnologyRecord> request) {
		...
		result = this.repository.findAllByRating();
