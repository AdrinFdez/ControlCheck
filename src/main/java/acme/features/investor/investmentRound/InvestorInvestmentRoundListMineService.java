...
@Service
public class InvestorInvestmentRoundListMineService implements AbstractListService<Investor, InvestmentRound> {
	...
	public Collection<InvestmentRound> findMany(final Request<InvestmentRound> request) {
		...
		res = this.repository.findManyById(principal.getActiveRoleId());
